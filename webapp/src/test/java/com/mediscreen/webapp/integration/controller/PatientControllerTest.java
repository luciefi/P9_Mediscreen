...
public class PatientControllerTest {
    ...
    void getPatientList() throws Exception {
        ...
        // Act
        mockMvc.perform(get("/patient/list").param("page", "2")).andExpect(status().isOk());
    ...
    public void addPatientTest() throws Exception {
        mockMvc.perform(get("/patient/add")).andDo(print()).andExpect(status().isOk()).andExpect(view().name("addPatient")).andExpect(content().string(containsString("Add New Patient")));
    }

    @Test

    public void addPatientPostTest() throws Exception {
        mockMvc.perform(post("/patient/add").contentType(MediaType.APPLICATION_FORM_URLENCODED).content("familyName=TestNone&givenName=Test&dateOfBirth=1966-12-31&sex=F&address=1BrooksideSt&phone=100-222-3333")).andDo(print()).andExpect(status().isFound()).andExpect(view().name("redirect:/patient/list"));
    ...
    public void addPatientPostFormErrorTest() throws Exception {
        mockMvc.perform(post("/patient/add").contentType(MediaType.APPLICATION_FORM_URLENCODED).content("familyName=TestNone&givenName=Test&dateOfBirth=1966-12-31&sex=F&address=1BrooksideSt&phone=")).andDo(print()).andExpect(status().isOk()).andExpect(view().name("addPatient"));
    ...
    public void patientDetails() throws Exception {
        ...
        mockMvc.perform(get("/patient/details/1")).andDo(print()).andExpect(status().isOk()).andExpect(view().name("patientDetails"));
    ...
    public void updatePatientForm() throws Exception {
        Patient patient = new Patient();
        when(service.getPatient(anyLong())).thenReturn(patient);
        mockMvc.perform(get("/patient/update/1")).andDo(print()).andExpect(status().isOk()).andExpect(view().name("updatePatient")).andExpect(content().string(containsString("Update Patient")));
        verify(service, Mockito.times(1)).getPatient(1l);
    }
    ...
    public void updatePatientPostFormErrorTest() throws Exception {
        mockMvc.perform(post("/patient/update/1").contentType(MediaType.APPLICATION_FORM_URLENCODED).content("familyName=TestNone&givenName=Test&dateOfBirth=1966-12-31&sex=F&address=1BrooksideSt&phone=")).andDo(print()).andExpect(status().isOk()).andExpect(view().name("updatePatient"));
    ...
    public void deletePatientForm() throws Exception {
        Patient patient = new Patient();
        when(service.getPatient(anyLong())).thenReturn(patient);
        mockMvc.perform(get("/patient/delete/1")).andDo(print()).andExpect(status().isOk()).andExpect(view().name("deletePatient")).andExpect(content().string(containsString("Delete Patient")));
        verify(service, Mockito.times(1)).getPatient(1l);
    }
    ...
    public void deletePatientFormNotFound() throws Exception {
        when(service.getPatient(anyLong())).thenThrow(PatientClientException.class);
        mockMvc.perform(get("/patient/delete/1")).andDo(print()).andExpect(status().isFound()).andExpect(view().name("redirect:/patient/list"));
        verify(service, Mockito.times(1)).getPatient(1l);
    }
    ...
    public void deletePatientPostTest() throws Exception {
        mockMvc.perform(post("/patient/delete/1")).andDo(print()).andExpect(status().isFound()).andExpect(view().name("redirect:/patient/list"));
